...
class catigoryproduct extends StatefulWidget {
  static String id = 'catigoryproduct';
  final List list;
  final int index;
  catigoryproduct({this.list,this.index});

  @override
  _catigoryproductState createState() => _catigoryproductState();
}

class _catigoryproductState extends State<catigoryproduct> {
  ...
  Future getProduct() async {
    var url = Uri.parse('http://192.168.43.66/alfarasha/display_catigoryproduct.php');
    var response = await http.post(url, body: {
      "catigory_id": id,
    });
